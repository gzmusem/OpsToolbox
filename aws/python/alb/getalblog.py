...
def parse_log_line(line):
    ...
    if match:
        data = {
            ...
            "request_processing_time": match.group(6),
            "target_processing_time": match.group(7),
            "response_processing_time": match.group(8),
            "elb_status_code": match.group(9),
            "target_status_code": match.group(10),
            "received_bytes": match.group(11),
            "sent_bytes": match.group(12),
            "request": match.group(13),
            "user_agent": match.group(14),
            "ssl_cipher": match.group(15),
            "ssl_protocol": match.group(16),
            "target_group_arn": match.group(17),
            "trace_id": match.group(18),
            "domain": match.group(19),
            "certificate_arn": match.group(20),
            "forwarded": match.group(21),
            "redirect_url": match.group(22),
            "server_ip": match.group(23),
            "server_port": match.group(24),
            "protocol": match.group(25),
        }
        return data
    else:
        return None
